...
<%
	...
	try
	{
		...
		if (traders.size() > 0)
		{
			...
			{
				out.println("<tr><td width=225>" + traders.get(i) + "</td><td><font size=2>Set Password</font></td><td colspan=2 align=right><font size=2>&nbsp;&nbsp;<a href='Admin.jsp?delete=" + traders.get(i) + "'>Delete</a></font></td></tr>");
			}
